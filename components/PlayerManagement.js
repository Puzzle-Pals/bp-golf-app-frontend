export default function PlayerManagement() {
  return (
    <div style={{
      ...
      <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '1.25rem' }}>Player Management</h2>
      <p style={{ marginBottom: '1.5rem', color: '#F5E8C7' }}>
        Add, edit, or remove players from the league. Keep the roster up-to-date!
      </p>
      <table style={{ width: '100%', background: '#1B4D3E', color: '#F5E8C7', borderRadius: 8, overflow: 'hidden', marginBottom: 16 }}>
        <thead>
          <tr>
            <th style={{ padding: 8, borderBottom: '1px solid #C71585', textAlign: 'left' }}>Player Name</th>
